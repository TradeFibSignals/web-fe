// Skript pro generování signálů pro 1h timeframe
...
async function main() {
  try {
    ...
    // Spuštění generování signálů pro 1h timeframe
    console.log("Starting signal generation for 1h timeframe...")
    ...
    console.log("Checking signal statuses for 1h timeframe...")

    const statusResponse = await fetch(`${apiUrl}/api/signals/generate?timeframe=1h`, {
      method: "GET",
      headers: {
        "x-api-key": apiKey,
      },
    ...
    console.log("Signal generation process completed successfully for 1h timeframe")
  } catch (error) {
