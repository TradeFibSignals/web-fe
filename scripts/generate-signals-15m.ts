// Skript pro generování signálů pro 15m timeframe
...
async function main() {
  try {
    ...
    // Spuštění generování signálů pro 15m timeframe
    console.log("Starting signal generation for 15m timeframe...")
    ...
    console.log("Checking signal statuses for 15m timeframe...")

    const statusResponse = await fetch(`${apiUrl}/api/signals/generate?timeframe=15m`, {
      method: "GET",
      headers: {
        "x-api-key": apiKey,
      },
    ...
    console.log("Signal generation process completed successfully for 15m timeframe")
  } catch (error) {
